...
//You could do more here such as add a custom remote procedure call that can be invoked from your
//SCADA HMI web clients
/*
server.db.rpcdb.calls.myfunc = {
    call_function: function(call_data) {
        console.log('My custom rpc function was called with data:', data);
        //Return some jsonafiable object
